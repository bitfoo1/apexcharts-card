...
sed -i -e "s|https://github.com/bitfoo1/apexcharts-card/releases/download/.*/apexcharts-card.js|https://github.com/bitfoo1/apexcharts-card/releases/download/v${VERSION}/apexcharts-card.js|g" ./README.md
